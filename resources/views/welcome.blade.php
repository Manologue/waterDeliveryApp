        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg class="h-8 w-8 text-gray-500" fill="none" stroke-width="1.5" stroke="currentColor"
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                Laravel's robust library of first-party tools and libraries, such as <a
                                    ...
                                    href="https://envoyer.io">Envoyer</a> help you take your projects
                                to the next level. Pair them with powerful open source libraries like <a
                                    ...
                                    class="underline" href="https://laravel.com/docs/telescope">Telescope</a>, and
                                more.
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-4 flex justify-center sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <svg class="-mt-px h-5 w-5 text-gray-400" fill="none" stroke-width="1.5"
                        ...
                        <svg class="ml-4 -mt-px h-5 w-5 text-gray-400" fill="none" stroke-width="1.5"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path
