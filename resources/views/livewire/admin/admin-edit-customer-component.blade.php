<div>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold mb-4 py-3"><span class="text-muted fw-light">Form/</span> Edit User Customer</h4>
            <a class="btn btn-primary" href="{{ route('admin.customers') }}" style="margin-bottom: 10px;">Users
                Customer</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                 ...
                 <small class="text-muted float-end">Default label</small>
                     ...
                     <div class="col-sm-10">
                      <select class="form-control" wire:model="published" name="published">
