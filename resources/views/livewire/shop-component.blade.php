                        ...
                        <div class="sidebar-widget sidebar-category">
                            ...
                            <div class="widget-content">
                                <ul class="category-list clearfix">
                                    <li><a wire:click.prevent="changeOrderBy('Default Sorting')" href="#"><i
                                                class="far fa-long-arrow-right"></i>Default Sorting</a></li>
                                    <li><a wire:click.prevent="changeOrderBy('Liter: Low to High')" href="#"><i
                                                class="far fa-long-arrow-right"></i>Liter: Low to High</a></li>
                                    <li><a wire:click.prevent="changeOrderBy('Liter: High to Low')" href="#"><i
                                                class="far fa-long-arrow-right"></i>Liter: High to Low</a></li>
                                    <li><a wire:click.prevent="changeOrderBy('Sort By Newness')" href="#"><i
                    ...
                    <div class="our-shop">
                        <div class="item-shorting clearfix">
                            <div class="left-column pull-left clearfix">
                                <div class="text"> {{ count($products) }} Results</p>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                                        ...
                                        <div class="lower-content">
                                            ...
                                            <div class="btn-box">
                                                <a href="#"
                                                    ...
                                                    class="theme-btn btn-two">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
