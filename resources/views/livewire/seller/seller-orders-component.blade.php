<div>
    ...
    <div class="content-wrapper">
       ...
       <div class="container-xxl flex-grow-1 container-p-y">
           <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Table /</span> Orders</h4>
               ...
               <table class="table table-bordered">
                 ...
                 <tbody>
                  ...
                  @for ($i = 0; $i < count($orders); $i++)
                   ...
                   <tr>
                     <td>{{ $order->id }}</td>
                     <td><a href="{{ route('seller.report' , ['order_id' => $order->id] ) }}">Details</a></td>
         ...
         <span style="padding-top: 20px">
           {{-- {!!$orders[0]->withQueryString()->links('pagination::bootstrap-5')!!} --}}
         </span>
         <!--/ Bordered Table -->
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               <div class="modal-body pb-30 pt-30">
                       ...
                       <button type="button" onclick="closeModal()" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#deleteConfirmation">Cancel</button>
