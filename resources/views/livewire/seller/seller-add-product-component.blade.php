                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="addProduct">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="short_description">Short
                                        description</label>
                                    <div class="col-sm-10">
                                        <textarea name="short_description" class="form-control"
                                            placeholder="Short description" wire:model="short_description" cols="30"
                                            rows="5"></textarea>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="stock_status"
                                        wire:model="stock_status">Stock Status</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="featured"
                                        wire:model="featured">Featured</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="liter" step=".01" class="form-control"
                                            placeholder="Liter" wire:model="liter" />
                                        @error('liter')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
